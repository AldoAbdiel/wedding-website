$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            title: "Boda de Aldo & Jess",
            start: new Date('Apr 9, 2026 16:00'),
            end: new Date('Apr 10, 2026 00:00'),
            address: 'Hotel Boutique Mansion E. Borbón, Blvd. Venustiano Carranza 103, San Miguel, 37390 León de los Aldama, Gto.',
            description: "¡Nos encantará verte en nuestro gran día! Para cualquier duda, contacta a Aldo al +52 8116586511."
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if ($('#invite_code').val() !== '090426') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>¡Lo sentimos!</strong> Tu código de invitación es incorrecto.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbxTsMaunITrB0MFgaIEb70vbwiUh4tgkA3NH3vJD-Fgp_QAOupEU_BdEPFhzGr-LZy_FA/exec', data)
                .done(function (data) {
                    console.log(data);
